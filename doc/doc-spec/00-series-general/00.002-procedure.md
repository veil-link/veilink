...
sequenceDiagram
    ...
    amf ->>+ drf: NDRF_ACCESS_KEY_INSERT_REQUEST
    drf -->>- amf: NDRF_ACCESS_KEY_INSERT_RESPONSE
...
sequenceDiagram
    ...
    amf ->>+ drf: NDRF_ACCESS_KEY_QUERY_REQUEST
    drf -->>- amf: NDRF_ACCESS_KEY_QUERY_RESPONSE
    amf ->>+ pkf: NPKF_CERT_VALIDATION_REQUEST
    pkf -->>- amf: NPKF_CERT_VALIDATION_RESPONSE
    amf ->>+ drf: NDRF_IDENTITY_UPDATE_REQUEST
    drf -->>- amf: NDRF_IDENTITY_UPDATE_RESPONSE
...
sequenceDiagram
    ...
    smf ->>+ drf: NDRF_ACCESS_KEY_QUERY_REQUEST
    drf -->>- smf: NDRF_ACCESS_KEY_QUERY_RESPONSE
...
sequenceDiagram
    ...
    drf -->>- smf: NDRF_SESSION_DATA_RESPONSE
