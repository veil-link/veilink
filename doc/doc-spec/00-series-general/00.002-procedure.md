...
sequenceDiagram
    ...
    amf ->>+ pkf: NPKF_ACCESS_KEY_QUERY_REQUEST
    pkf -->>- amf: NPKF_ACCESS_KEY_QUERY_RESPONSE
...
sequenceDiagram
    ...
    smf ->>+ pkf: NPKF_ACCESS_KEY_QUERY_REQUEST
    pkf -->>- smf: NPKF_ACCESS_KEY_QUERY_RESPONSE
