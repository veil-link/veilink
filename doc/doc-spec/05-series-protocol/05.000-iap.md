...
type InitializationAccept struct {
    ...
    IdentityInformation InitializationIdentityInformation `valid:"required"`
...
| IdentityInformation | [InitializationIdentityInformation](#54-iap_initialization_identity_information) | M | Identity information setup via OAM. |
...
### 5.4 IAP_INITIALIZATION_IDENTITY_INFORMATION

```go
type InitializationIdentityInformation struct {
