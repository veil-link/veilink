...
type InitializationAccept struct {
    CertificateClient string `msgpack:"certificate_client"`
    CertificateServer string `msgpack:"certificate_server,omitempty"`
...
| Field | Type | Required | Description |
| - | - | - | - |
| CertificateClient | string | M | The certificate for the identity to obtain authorization in the Veil-link system and data plane's QUIC connection. |
| CertificateServer | string | O | The certificate use for router to be the QUIC server. |
